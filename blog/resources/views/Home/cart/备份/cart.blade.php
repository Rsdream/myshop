											...
											<div class="products-wrapper">
												<div class="cart_totals ">
													...
													<table cellspacing="0" class="shop_table shop_table_responsive">
														<tbody>
															...
															<tr class="order-total">
																<th>Total</th>
																<td data-title="实付">
																	<strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">￥</span ><span class="mytotal"></span></span></strong> 
																</td>
															</tr>
														</tbody>
													</table>
													...
													<div class="wc-proceed-to-checkout">
														<a href="checkout.html" class="checkout-button button alt wc-forward">结算</a>
													</div>
												</div>
											</div>
										</div>
