						...
						<div class="entry-content">
							<div class="entry-summary">
								...
								<div id="noshop" style="width: 100%;height: 100px;text-align: center;font-size: 15px;display: none">
								    <span>¹ºÎï³µÄÚÔÝÊ±Ã»ÓÐÉÌÆ·£¬µÇÂ¼ºó½«ÏÔÊ¾ÄúÖ®Ç°¼ÓÈëµÄÉÌÆ·</span><br>
								    <span><a href="" style="color:red">µÇÂ¼</a></span>&nbsp;&nbsp;&nbsp;<span><a  href="" style="color:orange;">¹ºÎï¡·</a></span>
								</div>
									<form action="" method="post" id="cart" style="display: none;">
										<table class="shop_table shop_table_responsive cart" cellspacing="0">
											<thead>
											    <center>
												<tr>
													<th class="product-remove">²Ù×÷</th>
													<th class="product-thumbnail">Í¼Æ¬</th>
													<th class="product-name">ÉÌÆ·Ãû</th>
													<th class="product-price">¼Û¸ñ</th>
													<th class="product-quantity">ÊýÁ¿</th>
													<th class="product-subtotal">Ð¡¼Æ</th>
												</tr>
												</center>
											</thead>
												...
												<tr>
													<td colspan="6" class="actions">
														<div class="coupon" style="float:right;">
															...
															<input type="submit" class="button" name="apply_coupon" value="½áËã">
														</div>														
														<div class="coupon" style="float:right;">
															<label for="coupon_code">Coupon:</label> 
															<span style="font-size: 20px">×Ü¼Û£º<span style="color:red">£¤</span><span style="color:red" id="total">2</span></span>
														</div>
														<input type="submit" class="button" name="update_cart" value="Çå¿Õ">		
													</td>
												</tr>
    	    		...
    	    		for (var i = 0; i<data.length; i++) {
    	    			str += `<tr class="cart_item">
							<td class="product-remove">
								<a href="javascript:;" class="remove" onclick="del(this)" id="`+data[i].id+`" title="É¾³ý´ËÉÌÆ·"><i class="fa fa-times" aria-hidden="true"></i></a>			
							</td>
							...
							<td class="product-quantity" data-title="Quantity">
								<div class="quantity">
									<input type="number" step="1" min="1" max="`+data[i].stock+`" name="number" value="`+data[i].num+`" title="Qty"  class="input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric">
							    </div>
							</div>
							</td>
							...
							<td class="product-subtotal" data-title="Total">
							    ...
							    <span class="woocommerce-Price-currencySymbol" >£¤</span ><span class="total">`+data[i].num*data[i].price+`</span></span>				
							</td>
