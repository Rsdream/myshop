...
<div class="page-container">
	<form onsubmit="return check()" action="{{url('/admin/product/goods', ['id'=>$goodsData[0]->id])}}" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		{{ method_field('PUT') }}
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input title="商品名" type="text" class="input-text" value="{{$goodsData[0]->gname}}" placeholder="" id="" name="gname">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="category" class="select">
					@foreach($categoryList as $k=>$v)
						<option {{$v->id==$goodsBrand->id?'selected':''}} value="{{$v->id}}">{{$v->name}}</option>
					@endforeach
				</select>
				</span> </div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="brand" class="select">
					@foreach($brandList as $k=>$v)
						<option {{$k==$goodsBrand->bid?'selected':''}} value="{{$k}}">{{$v}}</option>
					@endforeach
				</select>
				</span> </div>
		</div>
		...
		<div id='box' class="row cl">
			...
			<?php $i++ ?>
			<label class="form-label col-xs-4 col-sm-2">填写配置{{$i}}：</label>
			<div class="formControls col-xs-2 col-sm-9">
				<label class="form-label col-xs-1 col-sm-1">运行内存</label>
				<div class="formControls col-xs-1 col-sm-1">
					<input title="运行内存" type="text" name="ram{{$i}}" id="" placeholder="" value="{{$v->ram}}" class="input-text" style="width:90%">
				</div>
				<label class="form-label col-xs-1 col-sm-1">存储容量</label>
				<div class="formControls col-xs-1 col-sm-1">
					<input title="存储容量" type="text" name="rom{{$i}}" id="" placeholder="" value="{{$v->rom}}" class="input-text" style="width:90%">
				</div>
				<label class="form-label col-xs-1 col-sm-1">颜色</label>
				<div class="formControls col-xs-1 col-sm-1">
					<input title="颜色" type="text" name="color{{$i}}" id="" placeholder="" value="{{$v->color}}" class="input-text" style="width:90%">
				</div>
				<label class="form-label col-xs-1 col-sm-1">价格</label>
				<div class="formControls col-xs-1 col-sm-1">
					<input title="价格" type="text" name="price{{$i}}" id="" placeholder="" value="{{$v->price}}" class="input-text" style="width:90%">
				</div>
				<label class="form-label col-xs-1 col-sm-1">库存</label>
				<div class="formControls col-xs-1 col-sm-1">
					<input title="库存" type="text" name="stock{{$i}}" id="" placeholder="" value="{{$v->stock}}" class="input-text" style="width:90%">
				</div>
			</div>
			@endforeach
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="detail" cols=""  rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" >{{$detail->gdetail}}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<img style='border:1px solid ;' alt="点击选择图片" id="pic" src="{{asset(json_decode($goodsData[0]->gpic, true)[0])}}" >
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server: '{{url("/admin/product/goodsimg/".$goodsData[0]->id)}}',
