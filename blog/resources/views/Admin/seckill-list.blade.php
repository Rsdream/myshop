...
<div style="margin-left:0px;">
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <button class="btn radius" onclick="product_add('添加秒杀','{{url('admin/seckill/create')}}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加秒杀</button></span> </div>
		<div class="mt-20">
